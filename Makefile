...
PACKAGE=github.com/dzendos/avito-challenge/cmd/service
BOT=github.com/dzendos/avito-challenge/cmd/bot

all: format build test lint

build: bindir
	go build -o ${BINDIR}/service ${PACKAGE}
	go build -o ${BINDIR}/bot ${BOT}
...
generate: install-mockgen
	${MOCKGEN} -source=microservice/service.go -destination=microservice/mocks/service.go
